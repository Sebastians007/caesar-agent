# Streaming LLM Response Support for Caesar Agent
...
```
CAESAR_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("CAESAR_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `caesar_cli/config.py` | 1 | +streaming config defaults |
