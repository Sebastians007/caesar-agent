#!/usr/bin/env python3
"""
SWE Runner with Caesar Trajectory Format

A runner that uses Caesar-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Caesar-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Caesar-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Caesar format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Caesar-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Caesar-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Caesar Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Caesar-Agent's built-in execution environments
    and outputs trajectories in Caesar-Agent format.
    """
    ...
    def _convert_to_caesar_format(
        ...
        """
        Convert internal message format to Caesar trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Caesar trajectory format
        trajectory = self._convert_to_caesar_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Caesar trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Caesar Trajectory Format")
    print("=" * 60)
