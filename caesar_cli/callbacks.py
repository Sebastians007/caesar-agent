...
into prompt_toolkit's event loop. Each function takes the CaesarCLI instance
...
from caesar_cli.banner import cprint, _DIM, _RST
from caesar_cli.config import save_env_value_secure
...
def prompt_for_secret(cli, var_name: str, prompt: str, metadata=None) -> dict:
    ...
    The secret is stored in ~/.caesar/.env and never exposed to the model.
    """
