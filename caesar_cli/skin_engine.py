"""Caesar CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.caesar/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Caesar Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Caesar "       # Response box header label
...
.. code-block:: python
    ...
    from caesar_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Caesar Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.caesar/skins/

BUILT-IN SKINS
==============

- ``default`` — Classic Caesar gold/kawaii (the current look)
...
Drop a YAML file in ``~/.caesar/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces CAESAR_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces CAESAR_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Caesar — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Caesar Agent",
            "welcome": "Welcome to Caesar Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Caesar ",
            "prompt_symbol": "❯ ",
