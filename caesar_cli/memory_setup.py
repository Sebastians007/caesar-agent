"""caesar memory setup|status — configure memory provider plugins.
...
# ---------------------------------------------------------------------------
# Curses-based interactive picker (same pattern as caesar tools)
# ---------------------------------------------------------------------------
...
def cmd_setup(args) -> None:
    ...
    if not providers:
        ...
        print("  Install a plugin to ~/.caesar/plugins/ and try again.\n")
        return
    ...
    env_path = Path(os.environ.get("CAESAR_HOME", os.path.expanduser("~/.caesar"))) / ".env"
    env_writes = {}
    ...
    caesar_home = str(Path(os.environ.get("CAESAR_HOME", os.path.expanduser("~/.caesar"))))
    if provider_config and hasattr(provider, "save_config"):
        try:
            provider.save_config(provider_config, caesar_home)
        except Exception as e:
...
def cmd_status(args) -> None:
    ...
    if provider_name:
        ...
        if found:
            ...
            print(f"  Install the '{provider_name}' memory plugin to ~/.caesar/plugins/")
