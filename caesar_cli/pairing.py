...
Usage:
    caesar pairing list              # Show all pending + approved users
    caesar pairing approve <platform> <code>  # Approve a pairing code
    caesar pairing revoke <platform> <user_id> # Revoke user access
    caesar pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle caesar pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: caesar pairing {list|approve|revoke|clear-pending}")
        print("Run 'caesar pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'caesar pairing list' to see pending codes.\n")
