...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - caesar_home (str): The active CAESAR_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.caesar``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "caesar").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'caesar memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], caesar_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'caesar memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``caesar_home`` is the active CAESAR_HOME directory path.
