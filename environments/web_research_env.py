...
Inspired by: GroceryMind — production Caesar agent doing live web research
             across German grocery stores (firecrawl + caesar-agent)
"""
...
# Ensure caesar-agent root is on path
...
class WebResearchEnvConfig(CaesarAgentEnvConfig):
...
class WebResearchEnv(CaesarAgentBaseEnv):
    """
