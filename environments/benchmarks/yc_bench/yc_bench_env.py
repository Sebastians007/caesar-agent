...
The evaluate flow:
    ...
    2. evaluate()  -- Iterates over all runs sequentially through:
        a. rollout_and_score_eval()  -- Per-run agent loop
            ...
            - Runs CaesarAgentLoop with terminal tool only
...
Requires: pip install caesar-agent[yc-bench]
"""
...
class YCBenchEvalConfig(CaesarAgentEnvConfig):
    """
    Configuration for the YC-Bench evaluation environment.

    Extends CaesarAgentEnvConfig with YC-Bench-specific settings for
...
class YCBenchEvalEnv(CaesarAgentBaseEnv):
    """
    ...
    a competing built-in agent loop). The CaesarAgentLoop then drives the
    ...
    async def rollout_and_score_eval(self, eval_item: Dict[str, Any]) -> Dict:
        ...
        3. Runs CaesarAgentLoop with terminal tool
        ...
        try:
            ...
            # LiteLLM), which would compete with our CaesarAgentLoop.
            ...
            # ----------------------------------------------------------
            # Step 2: Run the CaesarAgentLoop
            # ----------------------------------------------------------
