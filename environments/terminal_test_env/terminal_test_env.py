...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from Caesar Agent"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from Caesar Agent",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from Caesar Agent",
    },
    {
...
class TerminalTestEnv(CaesarAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        Claude for inference. API keys loaded from ~/caesar-agent/.env.
        """
