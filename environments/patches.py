"""
Monkey patches for making caesar-agent tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by caesar_base_env.py).
