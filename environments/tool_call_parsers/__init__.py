...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("caesar")
        class CaesarToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "caesar", "mistral", "llama3_json")
...
from environments.tool_call_parsers.caesar_parser import CaesarToolCallParser  # noqa: E402, F401
