"""
CaesarSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser caesar
    run-api
    python environments/caesar_swe_env.py serve \\
...
class CaesarSweEnv(CaesarAgentBaseEnv):
    ...
    name = "caesar-swe"
    env_config_cls = CaesarSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[CaesarSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        env_config = CaesarSweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="NousResearch/DeepCaesar-3-Llama-3-3B-Preview",
            tool_call_parser="caesar",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="caesar-swe",
        )

        server_configs = [
            APIServerConfig(
                base_url="http://localhost:8000/v1",
                model_name="NousResearch/DeepCaesar-3-Llama-3-3B-Preview",
