...
class TestParserRegistry:
    ...
    def test_caesar_parser_registered(self):
        parsers = list_parsers()
        assert "caesar" in parsers
...
class TestCaesarParser:
    @pytest.fixture
    def parser(self):
        return get_parser("caesar")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["caesar"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use caesar format since that's universal
