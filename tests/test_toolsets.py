...
class TestToolsetConsistency:
    ...
    def test_caesar_platforms_share_core_tools(self):
        """All caesar-* platform toolsets should have the same tools."""
        platforms = ["caesar-cli", "caesar-telegram", "caesar-discord", "caesar-whatsapp", "caesar-slack", "caesar-signal", "caesar-homeassistant"]
