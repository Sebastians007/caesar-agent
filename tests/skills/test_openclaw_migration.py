...
"""
    ...
    assert "Tyler Williams > Active Projects: Caesar Agent" in entries
...
def test_skill_installs_cleanly_under_skills_guard():
    ...
    # caesar_config_mod  — print statements in the post-migration summary that
    #                      tell the user to *review* ~/.caesar/config.yaml;
    ...
    KNOWN_FALSE_POSITIVES = {"agent_config_mod", "python_os_environ", "caesar_config_mod"}
