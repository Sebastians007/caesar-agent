"""Tests for the interactive session browser (`caesar sessions browse`).
...
from caesar_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """caesar sessions browse should be parseable."""
        from caesar_cli.main import main as _main_entry
