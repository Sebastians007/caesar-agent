"""Tests for the caesar_cli models module."""

from caesar_cli.models import OPENROUTER_MODELS, menu_labels, model_ids, detect_provider_for_model
...
class TestFindOpenrouterSlug:
    def test_exact_match(self):
        from caesar_cli.models import _find_openrouter_slug
