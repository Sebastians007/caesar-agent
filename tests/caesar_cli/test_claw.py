"""Tests for caesar claw commands."""
...
from caesar_cli import claw as claw_mod
...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.caesar/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.caesar/memories/MEMORY.md"},
    ...
    def test_execute_report(self, capsys):
        report = {
            ...
            "output_dir": "/home/user/.caesar/migration/openclaw/20250312T120000",
        }
