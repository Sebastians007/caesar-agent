"""Tests for caesar_cli/skills_config.py and skills_tool disabled filtering."""
import pytest
...
class TestGetDisabledSkills:
    def test_empty_config(self):
        from caesar_cli.skills_config import get_disabled_skills
...
class TestSaveDisabledSkills:
    @patch("caesar_cli.skills_config.save_config")
    def test_saves_global_sorted(self, mock_save):
        from caesar_cli.skills_config import save_disabled_skills
        config = {}
...
class TestIsSkillDisabled:
    @patch("caesar_cli.config.load_config")
    ...
    @patch("caesar_cli.config.load_config")
    @patch.dict("os.environ", {"CAESAR_PLATFORM": "discord"})
...
class TestGetCategories:
    def test_extracts_unique_categories(self):
        from caesar_cli.skills_config import _get_categories
        skills = [
