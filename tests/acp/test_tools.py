...
COMMON_CAESAR_TOOLS = ["read_file", "search_files", "terminal", "patch", "write_file", "process"]


class TestToolKindMap:
    def test_all_caesar_tools_have_kind(self):
        """Every common caesar tool should appear in TOOL_KIND_MAP."""
        for tool in COMMON_CAESAR_TOOLS:
