...
class TestGatewayIntegration(unittest.TestCase):
    ...
    def test_feishu_toolset_exists(self):
        ...
        self.assertIn("caesar-feishu", TOOLSETS)
        self.assertIn("caesar-feishu", TOOLSETS["caesar-gateway"]["includes"])
...
class TestFeishuAdapterMessaging(unittest.TestCase):
    ...
    def test_get_chat_info_uses_real_feishu_chat_api(self):
        ...
        class _ChatAPI:
            def get(self, request):
                ...
                return SimpleNamespace(
                    success=lambda: True,
                    data=SimpleNamespace(name="Caesar Group", chat_type="group"),
                )
        ...
        self.assertEqual(info["name"], "Caesar Group")
...
class TestAdapterBehavior(unittest.TestCase):
    ...
    def test_group_post_message_uses_parsed_mentions_when_sdk_mentions_missing(self):
        ...
        message = SimpleNamespace(
            message_type="post",
            mentions=[],
            content='{"en_us":{"content":[[{"tag":"at","user_name":"Caesar","open_id":"ou_bot"}]]}}',
        )
    ...
    @patch.dict(
        os.environ,
        {
            "CAESAR_FEISHU_TEXT_BATCH_MAX_MESSAGES": "2",
        },
        clear=True,
    )
    ...
    def test_dedup_state_persists_across_adapter_restart(self):
        ...
        with tempfile.TemporaryDirectory() as temp_home:
            with patch.dict(os.environ, {"CAESAR_HOME": temp_home}, clear=False):
