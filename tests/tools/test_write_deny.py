...
class TestWriteDenyExactPaths:
    ...
    def test_caesar_env(self):
        path = os.path.join(str(Path.home()), ".caesar", ".env")
        assert _is_write_denied(path) is True
...
class TestWriteAllowed:
    ...
    def test_caesar_config_not_env(self):
        path = os.path.join(str(Path.home()), ".caesar", "config.yaml")
