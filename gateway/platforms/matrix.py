...
# Uses get_caesar_home() so each profile gets its own Matrix store.
from caesar_constants import get_caesar_dir as _get_caesar_dir
_STORE_DIR = _get_caesar_dir("platforms/matrix/store", "matrix/store")
...
_KEY_EXPORT_PASSPHRASE = "caesar-matrix-e2ee-keys"
...
class MatrixAdapter(BasePlatformAdapter):
    ...
    async def _run_e2ee_maintenance(self) -> None:
        ...
        Caesar uses a custom sync loop instead of matrix-nio's sync_forever(),
