"""
Email platform adapter for the Caesar gateway.

Allows users to interact with Caesar by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Caesar Agent")
        ...
        msg_id = f"<caesar-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
