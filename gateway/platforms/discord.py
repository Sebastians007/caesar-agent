...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="reset", description="Reset your Caesar session")
        ...
        @tree.command(name="status", description="Show Caesar session status")
        ...
        @tree.command(name="stop", description="Stop the running Caesar agent")
        ...
        @tree.command(name="update", description="Update Caesar Agent to the latest version")
        async def slash_update(interaction: discord.Interaction):
            await self._run_simple_slash(interaction, "/update", "Update initiated~")

        @tree.command(name="thread", description="Create a new thread and start a Caesar session in it")
        @discord.app_commands.describe(
            name="Thread name",
            message="Optional first message to send to Caesar in the thread",
    ...
    async def _handle_thread_create_slash(
        ...
        # If a message was provided, kick off a new Caesar session in the thread
    ...
    async def _create_thread(
        ...
        *,
        ...
        try:
            ...
            try:
                seed_content = starter_message or f"\U0001f9f5 Thread created by Caesar: **{name}**"
    ...
    async def _auto_create_thread(self, message: 'DiscordMessage') -> Optional[Any]:
        ...
        thread_name = content[:80] if content else "Caesar"
        if len(content) > 80:
    ...
    def _thread_state_path() -> Path:
        ...
        return get_caesar_home() / "discord_threads.json"
