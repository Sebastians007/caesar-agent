...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._media_batch_delay_seconds = float(os.getenv("CAESAR_TELEGRAM_MEDIA_BATCH_DELAY_SECONDS", "0.8"))
        ...
        self._text_batch_delay_seconds = float(os.getenv("CAESAR_TELEGRAM_TEXT_BATCH_DELAY_SECONDS", "0.6"))
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        message = (
            ...
            "Caesar stopped Telegram polling after %d retries. "
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            if not acquired:
                ...
                message = (
                    "Another local Caesar gateway is already using this Telegram bot token"
            ...
            try:
                ...
                from caesar_cli.commands import telegram_menu_commands
