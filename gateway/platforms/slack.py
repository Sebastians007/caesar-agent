...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_caesar_home() / "slack_tokens.json"
        ...
        try:
            ...
            @self._app.command("/caesar")
            async def handle_caesar_command(ack, command):
                await ack()
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        from caesar_cli.commands import slack_subcommand_map
