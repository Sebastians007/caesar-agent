...
Hooks are discovered from ~/.caesar/hooks/ directories, each containing:
...
HOOKS_DIR = get_caesar_home() / "hooks"
    ...
    def _register_builtin_hooks(self) -> None:
        ...
        try:
            ...
            self._loaded_hooks.append({
                "name": "boot-md",
                "description": "Run ~/.caesar/BOOT.md on gateway startup",
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                spec = importlib.util.spec_from_file_location(
                    f"caesar_hook_{hook_name}", handler_path
                )
