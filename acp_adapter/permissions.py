"""ACP permission bridging — maps ACP approval requests to caesar approval callbacks."""
...
# Maps ACP PermissionOptionKind -> caesar approval result strings
_KIND_TO_CAESAR = {
    "allow_once": "once",
    "allow_always": "always",
    "reject_once": "deny",
...
def make_approval_callback(
    ...
    """
    Return a caesar-compatible ``approval_callback(command, description) -> str``
        ...
        if isinstance(outcome, AllowedOutcome):
            ...
            for opt in options:
                if opt.option_id == option_id:
                    return _KIND_TO_CAESAR.get(opt.kind, "deny")
