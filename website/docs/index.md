...
slug: /
sidebar_position: 0
title: "Caesar Agent Documentation"
description: "The self-improving AI agent built by Sebastian Sartele. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
hide_table_of_contents: true
---

# Caesar Agent

The self-improving AI agent, forked from [Caesar Agent](https://github.com/Sebastians007/caesar-agent) and customized by [Sebastian Sartele](https://github.com/Sebastians007). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/Sebastians007/caesar-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>

## What is Caesar Agent?
...
| 🔌 **[MCP Integration](/docs/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Caesar safely |
| 🧭 **[Use MCP with Caesar](/docs/guides/use-mcp-with-caesar)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/docs/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Caesar](/docs/guides/use-voice-mode-with-caesar)** | Hands-on setup and usage patterns for Caesar voice workflows |
| 🎭 **[Personality & SOUL.md](/docs/user-guide/features/personality)** | Define Caesar' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/docs/guides/tips)** | Quick wins to get the most out of Caesar |
...
- **Built by Sebastian Sartele** — Forked from [Hermes Agent](https://github.com/Sebastians007/caesar-agent) by Nous Research and customized by [Sebastian Sartele](https://github.com/Sebastians007). Originally Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Originally built by [Nous Research](https://nousresearch.com) — the lab behind Hermes, Nomos, and Psyche models
