...
Caesar Agent can generate images from text prompts using FAL.ai's **FLUX 2 Pro** model with automatic 2x upscaling via the **Clarity Upscaler** for enhanced quality.
...
When you ask Caesar to generate an image:
...
Simply ask Caesar to create an image:
