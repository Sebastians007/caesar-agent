...
title: "SMS (Twilio)"
description: "Set up Caesar Agent as an SMS chatbot via Twilio"
---

# SMS Setup (Twilio)

Caesar connects to SMS through the [Twilio](https://www.twilio.com/) API. People text your Twilio phone number and get AI responses back — same conversational experience as Telegram or Discord, but over standard text messages.
...
- **aiohttp** — `pip install 'caesar-agent[sms]'`
...
If you're running Caesar locally, use a tunnel to expose the webhook:
...
Text your Twilio number — Caesar will respond via SMS.
...
3. Check Caesar gateway logs for Twilio API errors
