// =========================================================================
// Caesar Agent Landing Page — Interactions
// =========================================================================
...
const demoSequence = [
  ...
  {
    type: "type",
    text: "Review the PR at Sebastians007/caesar-agent#42 and fix any issues",
    delay: 30,
  },
  { type: "pause", ms: 600 },
  {
...
// --- Noise Overlay (ported from caesar-chat NoiseOverlay) ---
