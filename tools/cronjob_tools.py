"""
Cron job management tools for Caesar Agent.
...
def _origin_from_env() -> Optional[Dict[str, str]]:
    origin_platform = os.getenv("CAESAR_SESSION_PLATFORM")
    origin_chat_id = os.getenv("CAESAR_SESSION_CHAT_ID")
    if origin_platform and origin_chat_id:
        return {
            "platform": origin_platform,
            "chat_id": origin_chat_id,
            "chat_name": os.getenv("CAESAR_SESSION_CHAT_NAME"),
            "thread_id": os.getenv("CAESAR_SESSION_THREAD_ID"),
        }
    return None
...
def check_cronjob_requirements() -> bool:
    ...
    """
    return bool(
        os.getenv("CAESAR_INTERACTIVE")
        or os.getenv("CAESAR_GATEWAY_SESSION")
        or os.getenv("CAESAR_EXEC_ASK")
    )
