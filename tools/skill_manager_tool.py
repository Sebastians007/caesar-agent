...
~/.caesar/skills/. Existing skills (bundled, hub-installed, or user-created)
...
# All skills live in ~/.caesar/skills/ (single source of truth)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    """
    Find a skill by name in ~/.caesar/skills/.
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "New skills go to ~/.caesar/skills/; existing skills can be modified wherever they live.\n\n"
