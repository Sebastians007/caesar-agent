...
Trust levels:
  - builtin:   Ships with Caesar. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.caesar/\.env|\~/\.caesar/\.env',
     "caesar_env_access", "critical", "exfiltration",
     "directly references Caesar secrets file"),
    ...
    (r'\.caesar/config\.yaml|\.caesar/SOUL\.md',
     "caesar_config_mod", "critical", "persistence",
     "references Caesar configuration files directly"),
...
def _get_configured_model() -> str:
    """Load the user's configured model from ~/.caesar/config.yaml."""
    try:
