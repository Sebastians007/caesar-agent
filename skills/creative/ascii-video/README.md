...
Built for [Caesar Agent](https://github.com/Sebastians007/caesar-agent). Usable in any coding agent. Canonical source lives here; synced to [`Sebastians007/caesar-agent/skills/creative/ascii-video`](https://github.com/Sebastians007/caesar-agent/tree/main/skills/creative/ascii-video) via PR.
