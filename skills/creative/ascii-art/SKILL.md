...
```bash
python3 -m pyfiglet "CAESAR" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=CAESAR&font=Slant" | boxes -d stone
```
