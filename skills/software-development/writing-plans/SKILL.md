...
version: 1.1.0
author: Caesar Agent (adapted from obra/superpowers)
license: MIT
metadata:
  caesar:
...
> **For Caesar:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Caesar tools to understand the project:
