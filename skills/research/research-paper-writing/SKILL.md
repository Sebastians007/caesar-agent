...
## Caesar Agent Integration

This skill is designed for the Caesar agent. It uses Caesar tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Caesar skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.caesar/plans/` | `skill_view("plan")` |
