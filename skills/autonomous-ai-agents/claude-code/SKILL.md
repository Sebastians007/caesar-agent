...
metadata:
  caesar:
    ...
    related_skills: [codex, caesar-agent]
---

# Claude Code

Delegate coding tasks to [Claude Code](https://docs.anthropic.com/en/docs/claude-code) via the Caesar terminal. Claude Code is Anthropic's autonomous coding agent CLI.
