...
metadata:
  caesar:
    ...
    related_skills: [claude-code, caesar-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Caesar terminal. Codex is OpenAI's autonomous coding agent CLI.
