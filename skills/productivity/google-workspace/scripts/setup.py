#!/usr/bin/env python3
"""Google Workspace OAuth2 setup for Caesar Agent.
...
TOKEN_PATH = CAESAR_HOME / "google_token.json"
CLIENT_SECRET_PATH = CAESAR_HOME / "google_client_secret.json"
PENDING_AUTH_PATH = CAESAR_HOME / "google_oauth_pending.json"
...
def store_client_secret(path: str):
    """Copy and validate client_secret.json to Caesar home."""
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace OAuth setup for Caesar")
