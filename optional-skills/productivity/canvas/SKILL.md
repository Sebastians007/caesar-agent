...
4. Name the token (e.g., "Caesar Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.caesar/.env`:
...
```bash
CANVAS="python $CAESAR_HOME/skills/productivity/canvas/scripts/canvas_api.py"
