...
Data file: $CAESAR_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_CAESAR_HOME = Path(os.environ.get("CAESAR_HOME", Path.home() / ".caesar"))
DATA_DIR = _CAESAR_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
